...
public:
	...
	ERRandomiser(bool is_random_keys, bool is_randomise_estusupgrade, uint32_t mapitem_seed, uint32_t enemyitem_seed, uint64_t solo_param_repository_class, get_equipparamgoods_entry* find_equipparamgoods_function) {
		...
		param_randomisation_instruction_map.emplace(L"ItemLotParam_enemy", &ERRandomiser::ShuffleItemLotParam_enemy);
		...
		param_randomisation_instruction_map.emplace(L"EquipParamGem", &ERRandomiser::ShuffleAshParam);
...
private:
	...
	bool ShuffleItemLotParam_enemy(uint64_t solo_param_repository, std::wstring param_name, uint32_t seed, bool shuffle, bool scramble);
	...
	bool ShuffleAshParam(uint64_t solo_param_repository, std::wstring param_name, uint32_t seed, bool shuffle, bool scramble);
